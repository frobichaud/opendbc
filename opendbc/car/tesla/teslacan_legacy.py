...
class TeslaCANRaven:
  ...
  def create_steering_control(self, counter, angle, enabled, control_type):
    # Legacy safety only allows types 0 (NONE) and 1 (ANGLE_CONTROL)
    values = {
      "DAS_steeringControlCounter": counter,
      "DAS_steeringAngleRequest": -angle,
      "DAS_steeringHapticRequest": 0,
      "DAS_steeringControlType": min(control_type, 1) if enabled else 0,
    }
